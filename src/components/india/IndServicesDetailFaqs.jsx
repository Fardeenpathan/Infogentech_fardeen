...
const IndServicesDetailFaqs = ({ graphicdetailsfaqs }) => {
  ...
  const fetchBlogFaqs = async () => {
    try {
      setLoadingFaqs(true);
      let faqs = [];
      if (graphicdetailsfaqs.faqs && Array.isArray(graphicdetailsfaqs.faqs)) {
        faqs = graphicdetailsfaqs.faqs;
      } else {
      ...
      if (graphicdetailsfaqs.faqs && Array.isArray(graphicdetailsfaqs.faqs)) {
        const activeFaqs = graphicdetailsfaqs.faqs
