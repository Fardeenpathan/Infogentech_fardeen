...
const IndFaqsHome = () => {
  ...
  <motion.div
    className="flex flex-col xl:flex-row justify-between gap-10 2xl:gap-30"
  ...
  >
    <motion.div
      ...
      viewport={{ once: true }}
      className="w-full xl:w-1/2 shrink-0 flex justify-center"
    >
      <Image
        ...
        width={762}
        height={400}
        className="object-fit rounded-2xl xl:h-130 h-64 w-full"
      />
    </motion.div>
    <motion.div
      initial={{ opacity: 0, x: 100 }}
