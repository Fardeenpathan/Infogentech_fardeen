  ...
  return (
    <section className="px-2 lg:px-10">
      ...
      <div className="relative z-20 p-10  text-white">
        ...
        <motion.p
          className="font-montserrat font-medium xl:text-base text-[12px] leading-[1.5] tracking-[-0.02em] xl:mb-10"
          initial={{ opacity: 0, x: -100 }}
          whileInView={{ opacity: 1, x: 0 }}
        ...
        <a href="/contact ">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <IndButton variant="outline" className="!bg-white !text-primary !text-lg xl:!px-14 !px-8 xl:!py-2.5 !py-1 !border-primary/20 mt-2">
               Let's Talk
            </IndButton>
          </motion.div>
        </a>
