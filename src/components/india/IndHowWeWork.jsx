...
export default function IndHowWeWork() {
  return (
    <section className="xl:mt-20 mt-10 px-4 sm:px-6  lg:pb-20 container mx-auto">
      ...
      <div className="lg:block hidden xl:hidden">
        <div>
          ...
          <div className="relative">
            ...
            <motion.div
              ...
              transition={{ duration: 0.6, ease: "easeOut" }}
              viewport={{ once: true }}
              className="absolute max-w-54 left-23.5 border-l-2 border-b-2 border-dashed border-[#B493FF] p-1 z-50 bg-white"
            >
              <h3 className=" text-base font-semibold text-gray-400 leading-[1.5] tracking-[-0.02em]">
                1. Understand Your Goals
              </h3>
              <p className="font-montserrat font-medium  text-sm tracking-tightest text-gray-200">
                We begin by listening to the goals of your business, your
                audience, and your market to create a custom-made digital
                marketing strategy.
              </p>
            ...
            <motion.div
              ...
              transition={{ duration: 0.6, ease: "easeOut", delay: 0.2 }}
              viewport={{ once: true }}
              className="absolute max-w-54 left-77 border-l-2 border-b-2 border-dashed border-[#B493FF] p-1 top-60 z-40 bg-white"
            >
              <h3 className="text-base font-semibold text-gray-400 leading-[1.5] tracking-[-0.02em]">
                2. Research & Plan
              </h3>
            ...
            <motion.div
              ...
              transition={{ duration: 0.6, ease: "easeOut", delay: 0.4 }}
              viewport={{ once: true }}
              className="absolute max-w-54 left-130.5 border-l-2 border-b-2 border-dashed border-[#B493FF] p-1 top-80 z-30 bg-white"
            >
              <h3 className=" text-base font-semibold text-gray-400 leading-[1.5] tracking-[-0.02em]">
                3. Launch Campaigns
              </h3>
            ...
            <motion.div
              ...
              transition={{ duration: 0.6, ease: "easeOut", delay: 0.6 }}
              viewport={{ once: true }}
              className="absolute max-w-54 left-184 border-l-2 border-b-2 border-dashed border-[#B493FF] p-1 top-90"
            >
              <div className="p-4 bg-purple-50 rounded-2xl">
                <h3 className=" text-base font-semibold text-primary leading-[1.5] tracking-[-0.02em] ">
                  Analyze & Optimize
                </h3>
                <p className="font-montserrat font-medium  text-sm tracking-tightest text-primary">
                  Analytics tools keep in touch with KPIs and user behavior to
                  make critical adjustments to campaigns that will enhance their
                  quality-tuning presentation, involvement, and ROI.
                </p>
          ...
          >
            ...
            <div className="p-4 top-90">
              ...
              <p className="font-montserrat font-medium  text-sm tracking-tightest text-gray-200 tracking-[-0.02em] ">
        ...
        <div className="relative">
          ...
          <motion.div
            ...
            transition={{ duration: 0.6, ease: "easeOut" }}
            viewport={{ once: true }}
            className="absolute max-w-65 left-44 border-l-2 border-b-2 border-dashed border-[#B493FF] p-4 z-50 bg-white"
          >
            <h3 className="text-xl font-semibold text-gray-400 leading-[1.5] tracking-[-0.02em]">
              1. Understand Your Goals
            </h3>
            <p className="font-montserrat font-medium text-base tracking-tightest text-gray-200">
              We begin by listening to the goals of your business, your
              audience, and your market to create a custom-made digital
              marketing strategy.
            </p>
          ...
          <motion.div
            ...
            transition={{ duration: 0.6, ease: "easeOut", delay: 0.2 }}
            viewport={{ once: true }}
            className="absolute max-w-65 left-108.5 border-l-2 border-b-2 border-dashed border-[#B493FF] p-4 top-60 z-40 bg-white"
          >
          ...
          <motion.div
            ...
            transition={{ duration: 0.6, ease: "easeOut", delay: 0.4 }}
            viewport={{ once: true }}
            className="absolute max-w-65 left-173 border-l-2 border-b-2 border-dashed border-[#B493FF] p-4 top-80 z-30 bg-white"
          >
            <h3 className="text-2xl font-semibold text-gray-400 leading-[1.5] tracking-[-0.02em]">
              3. Launch Campaigns
            </h3>
          ...
          <motion.div
            ...
            transition={{ duration: 0.6, ease: "easeOut", delay: 0.6 }}
            viewport={{ once: true }}
            className="absolute max-w-70 left-237.5 border-l-2 border-b-2 border-dashed border-[#B493FF] p-4 top-90"
          >
            <div className="p-4 bg-purple-50 rounded-2xl">
              <h3 className="text-2xl font-semibold text-primary leading-[1.5] tracking-[-0.02em] ">
                Analyze & Optimize
              </h3>
              <p className="font-montserrat font-medium text-base tracking-tightest text-primary">
                Analytics tools keep in touch with KPIs and user behavior to
                make critical adjustments to campaigns that will enhance their
                quality-tuning presentation, involvement, and ROI.
              </p>
        ...
        <motion.div
          ...
          transition={{ duration: 0.2, ease: "easeOut", delay: 0.4 }}
          viewport={{ once: true }}
          className="mt-80 max-w-4xl flex shrink-0 justify-center items-center px-4"
        >
          <Icons name="IndHomeService2" className="shrink-0" />
          <div className="p-4 top-90">
            <h3 className="text-xl font-semibold text-gray-400 leading-[1.5] tracking-[-0.02em]">
            ...
            <p className="font-montserrat font-medium text-base tracking-tightest text-gray-200 tracking-[-0.02em] ">
              At Infogentech, we focus on performance and keeping our customers
              satisfied. Our team essentially stays updated with the changing
              trends and technology in the industry to provide your business
              with a competitive advantage. By working globally in different
