        ...
        {cards.map((c, i) => (
          ...
          >
            <div className="relative bg-white/70 backdrop-blur-md flex flex-col md:flex-row items-center justify-center overflow-hidden transition-transform duration-300 hover:scale-[1.01] rounded-[49px] lg:px-8 px-0">
              <div className={`absolute top-0 left-6 sm:left-6 md:left-10 w-[200px] sm:w-[250px] md:w-[300px] h-1 rounded-md bg-gradient-to-r from-primary to-primary
                 ${i==1 ? "w-[250px] md:w-[600px]": i==2 ? "md:w-[1000px] w-[300px]" : ""}`} />
