...
const focuses = [
  {
    ...
    position:
      'absolute md:top-[25%]  lg:top-[23%] top-[28%] xl:-left-[380px]  lg:-left-[350px] md:-left-[290px] -left-[130px] -translate-y-1/2 text-right',
  },
  {
    icon: 'QualtiyAbout',
    ...
    position:
      'absolute md:top-[25%]  lg:top-[23%] top-[30%] xl:-right-[380px] lg:-right-[350px]  md:-right-[290px] -right-[130px] -translate-y-1/2 text-left',
  },
  {
    icon: 'DigitalAbout',
    ...
    desc: (
      <>
        We solve problems using<br />
        creativity and the latest technology.
      </>
    ),
    position:
  ...
  },
  {
    ...
    desc: (
      <>
        We move quickly and<br />
        adapt to keep you ahead.
      </>
    ),
    position:
    ...
    <div className="relative flex items-center justify-center py-40">
      ...
      >
        <div className="flex items-center gap-2 z-50">
          ...
          <h3 className="font-avalors md:text-2xl text-[10px] leading-8 tracking-[3px] font-bold">
            INFOGENTECH
          </h3>
        </div>
      ...
      {focuses.map((item, index) => {
        ...
        return (
          ...
          >
            ...
            <h4 className="font-jost font-medium xl:text-xl md:text-lg text-sm tracking-[0.03em]">
              {item.title}
            </h4>
            <p
              className={`font-kumbh-sans font-medium xl:text-xl text-sm leading-[120%] whitespace-normal break-words ${
