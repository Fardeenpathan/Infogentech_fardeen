...
<div className="flex justify-between mx-auto">
  <div className=" items-center mb-10 flex-col md:flex hidden">
  ...
  <div className="flex flex-col-reverse md:flex-row md:pl-10 pl-2 md:gap-10 gap-6 items-start">
    <div className="flex flex-col md:basis-1/2">
      <p className="md:text-[32px] text-2xl leading-[150%] capitalize font-avalors text-primary">
        Our Vision And Mission
      </p>
      <p className="lg:text-[26px] font-medium leading-[150%] text-sm align-middle font-jost text-[#C9C9C9]">
    ...
    <div className="md:basis-[30%] flex justify-center md:justify-start">
      <img
