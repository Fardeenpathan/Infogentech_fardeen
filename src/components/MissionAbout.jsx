  ...
  return (
    <div className="flex justify-between mx-auto">
      <motion.div
        ...
        viewport={{ once: true }}
        className="items-center mb-10 flex-col lg:flex hidden"
      >
      ...
      <div className="flex flex-col-reverse lg:flex-row md:pl-10 pl-2 md:gap-10 gap-6 items-center">
        ...
        >
          <h2 className="md:text-[32px] text-2xl leading-[150%] capitalize font-avalors text-primary">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="lg:basis-[30%] flex justify-center md:justify-start shrink-0 items-center"
        >
          <img
