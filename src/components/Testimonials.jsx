...
const reviews = [
  {
    id: 1,
    text: "Their SEO work boosted our visibility, taking us from barely appearing in searches to ranking on the first page for key healthcare keywords. Their expertise in the healthcare space is clear and impactful.",
    name: "— Ethan Roberts",
    role: "Owner, Cascade Remodeling (Seattle | Home Renovation)",
  ...
  },
  {
    ...
    role: "Marketing Director, Nova Dental Group (Dallas | Healthcare)",
  ...
  },
  {
    ...
    name: "Marcus Lee",
    role: "Co-Founder, Leaf & Brew (San Francisco | Specialty Coffee)",
    img: "/assist/img/Marcus.jpg",
    rating: 3,
  },
  {
    id: 4,
    text: "They helped us run ads that attracted the right customers. Within just a few weeks, we started receiving more calls, inquiries, and new projects, making a noticeable difference in our business growth.",
    name: "Sarah Mitchell",
    role: "BrightPath Logistics (Chicago | Logistics)",
    img: "/assist/img/sarah.jpg",
    rating: 5,
  },
  {
    id: 5,
    text: "Our new online store looks fantastic and works seamlessly. Shoppers find it much easier to browse and buy, resulting in increased sales, improved customer experience, and smoother, more enjoyable online shopping overall.",
    name: " Daniel Harris",
    role: "Trendy Threads (New York | Fashion)",
    img: "/assist/img/daniel.jpg",
    rating: 4,
  },
  {
    id: 6,
    text: "Their SEO and content strategy boosted our online visibility. We’re appearing more often in searches, attracting steady new clients, and seeing real business growth thanks to their thoughtful, consistent approach.",
    name: "Olivia Turner",
