...
export function MiniNavbar() {
  ...
  return (
    <div className=" bg-transparent mt-3 h-15 mx-auto z-50 container px-2 w-full">
      <div className="flex items-center border border-[#8E8E8E] rounded-md justify-between px-2 py-3">
        ...
        >
          ...
          <nav className="pt-10 space-y-4 border-b border-[#0A071B]/10">
            <Link
              ...
              onClick={() => setIsOpen(false)}
              className="block hover:text-[#8E8E8E] font-bold text-[28px] border-b-[1px]"
            >
              Services
            </Link>
            <Link
            ...
            <Link
              href="/aboutUs"
              onClick={() => setIsOpen(false)}
              className="block hover:text-[#8E8E8E] font-bold text-[28px] mb-2"
            >
              About us
            </Link>
            <Link
