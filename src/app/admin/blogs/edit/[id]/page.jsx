...
export default function EditBlogPage() {
  ...
  // Convert blocks to HTML for rich text editor
  ...
  useEffect(() => {
    const fetchBlog = async () => {
      ...
      try {
        ...
        console.log('Blog data:', response); // Debug log
        
        const blog = response.data || response;
        
        // Convert blocks to HTML for the rich text editor
        const htmlContent = convertBlocksToHtml(blog.blocks);
  ...
  const handleSubmit = async (status = 'draft') => {
    ...
    try {
      ...
      // Add featured image file if exists (new upload)
      ...
      const response = await adminApiService.updateBlog(params.id, blogData);
      console.log('Blog update response:', response); // Debug log
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-400 mt-1">Update with Medium-style editor</p>
          </div>
        </div>
        ...
        <div className="lg:col-span-3 space-y-6">
          ...
          <div>
            ...
            <RichTextEditor
              ...
              placeholder="Update your content... You can copy-paste from anywhere and format with toolbar!"
            />
          </div>
        </div>
