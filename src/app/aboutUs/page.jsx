...
const AboutUs = () => {
  return (
    <>
      <div className=" h-85 md:mt-30  mt-20 md:bg-[url('/assist/img/aboutBg.png')] bg-[url('/assist/img/subAbout.png')] container mx-auto relative md:px-10 px-4 bg-no-repeat">
        <div className="flex md:gap-10 gap-4 absolute top-2 px-4">
          <div className="flex  items-center mb-40 flex-col shrink-0">
            ...
            <div className="w-0.5 h-[300px] md:h-[400px] xl:h-[600px] rounded-full mt-4 bg-gradient-to-b from-purple-400 via-purple-500 to-purple-800"></div>
          </div>
          <div className="flex flex-col">
            <p className="font-avalors font-normal md:text-[75px] text-5xl leading-none  bg-[linear-gradient(91.32deg,_#6A27FF_-32.61%,_#FFFFFF_-19.98%,_#6A27FF_70.29%)] bg-clip-text text-transparent">
              About Us
            </p>
            <p className="font-jost font-medium md:text-[26px] text-sm leading-[150%] align-middle mt-4 text-[#C9C9C9]">
             ...
             <div className="grid grid-cols-2 md:grid-cols-4 gap-4  font-jost md:divide-x divide-gray-200  justify-between mt-10 md:mt-0">
      ...
      <div className="mt-96 xl:mt-60  container mx-auto relative md:px-10 px-4 mb-10 md:mb:0">
        <MissionAbout />
      </div>
      <MidHeader
