    ...
    <div className=" subContainer mx-auto p-3">
      <div className="flex flex-col xl:mt-35 mt-25 ">
        ...
        <p className="font-jost font-medium text-base sm:text-lg md:text-xl leading-relaxed mt-6">
          Welcome to the Infogentech Help Center, your dedicated hub for IT
          support, product guidance, and customer service. We know technology is
          the core of your business and we aim to ensure you always have the
          resources you need to maintain the integrity of your business.
        </p>
      </div>
      <aside className="flex flex-col p-2">
        <article className="space-y-6">
          <h4 className="font-avalors font-normal text-xl sm:text-2xl md:text-3xl lg:text-4xl leading-[100%] tracking-[0.03em] capitalize mb-4">
            FAQs & Knowledge Base -
          </h4>
          <p className="font-kumbh-sans text-base sm:text-lg md:text-xl lg:text-2xl font-medium">
          ...
          <p className="font-kumbh-sans text-base sm:text-lg md:text-xl lg:text-2xl font-medium">
            From Website Issues to Software Issues, our IT experts are here to
          ...
          <p className="font-kumbh-sans text-base sm:text-lg md:text-xl lg:text-2xl font-medium">
            Whether by phone or email, we are here to provide assistance
            whenever you need it.
          </p>

          <p className="font-jost font-medium text-base sm:text-lg md:text-xl leading-relaxed mt-9">
            At Infogentech, we believe support should go beyond solving
            problems, it should empower you to get the most out of your
            technology. Our Help Center is designed to give you peace of mind,
            reliable resources, and expert assistance whenever you need it.
          </p>
