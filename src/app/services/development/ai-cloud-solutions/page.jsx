export const metadata = {
  title: "AI & Cloud Solutions | Intelligent AI & Cloud Solutions",
  description:
    "Infogentech provides advanced cloud solutions and AI in India, which enable operational modernization and workflow automation.",
  keywords: [
    "AI and cloud solution services",
    "AI and cloud solution"
  ], 
  metadataBase: new URL("https://infogentech.com"),
  alternates: {
    canonical: "/services/development/ai-cloud-solutions",
    languages: {
      "en-US": "/services/development/ai-cloud-solutions",
    },
  },
  openGraph: {
    title: "AI & Cloud Solutions | Intelligent AI & Cloud Solutions",
    description:
      "Infogentech provides advanced cloud solutions and AI in India, which enable operational modernization and workflow automation.",
    url: "https://infogentech.com/services/development/ai-cloud-solutions",
  ...
  alternates: {
    canonical: "https://infogentech.com/services/development/ai-cloud-solutions",
    languages: {
      "en-US": "https://infogentech.com/services/development/ai-cloud-solutions",
    },
  },
  other: {
    "geo.region": "IN",
